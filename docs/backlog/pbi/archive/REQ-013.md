...
- **Design doc**: [01_roi_setup.md](../../../../../mhws-vision-server/docs/system/user_workflows/01_roi_setup.md), [01_roi_setup_api.md](../../../../../mhws-vision-server/docs/system/sequences/01_roi_setup_api.md), [ROI_CALIBRATOR.md](../../../ui/features/ROI_CALIBRATOR.md)
